...
rule all:
    input:
        ...
        fastq_trimmed_r1 = expand("fastqc_trimmed/{sample}_L001_R1_001_fastqc.html", sample=SAMPLES),
        fastq_trimmed_r2 = expand("fastqc_trimmed/{sample}_L001_R2_001_fastqc.html", sample=SAMPLES),
...
#        multiqc_report_trimmed = "multiqc/multiqc_report_trimmed.html",
        ...
        abyss_exploded_fastas = directory("phyluce-abyss/taxon-sets/all/exploded-fastas"),
        abyss_exploded_locus = directory("phyluce-abyss/taxon-sets/all/exploded-locus"),
...
rule fastqc:
    ...
    conda: "pipeline_files/pg_assembly.yml"
    shell:
        "fastqc -o fastqc {input.r1} {input.r2} &>{log}"
...
rule fastqc_trimmed:
    ...
    output:
        o1 = expand("fastqc_trimmed/{sample}_L001_R1_001_fastqc.html", sample=SAMPLES),
        o2 = expand("fastqc_trimmed/{sample}_L001_R2_001_fastqc.html", sample=SAMPLES)
...
rule phyluce_assembly_explode_get_fastas_file_abyss:
    ...
    output: exploded_fasta=directory("phyluce-abyss/taxon-sets/all/exploded-fastas"), exploded_locus=directory("phyluce-abyss/taxon-sets/all/exploded-locus")
    conda: "pipeline_files/phyenv.yml"
    # Command requires --input and not --alignments
    shell: "cd phyluce-abyss/taxon-sets/all; phyluce_assembly_explode_get_fastas_file --input all-taxa-incomplete.fasta --output exploded-fastas --by-taxon; phyluce_assembly_explode_get_fastas_file --input all-taxa-incomplete.fasta --output exploded-locus"

rule phyluce_abyss_quality_metrics:
# BBMap's Stats.sh assembly metrics for rnaspades assemblies
    input: directory("phyluce-abyss/taxon-sets/all/exploded-fastas")
